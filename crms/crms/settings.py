...
SECRET_KEY = 'django-insecure-^clq@^($mwvf5^+ez3$&k4qca3inzor5s7t*fo_-h=&es=mua0'
...
# https://www.codementor.io/@chirilovadrian360/adminlte-django-dashboard-19dqgq2cxv
# https://docs.bitnami.com/ibm/apps/joomla/configuration/configure-workbench/
# Password validation
